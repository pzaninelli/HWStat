...
#        ADHW_yearly, ADHW_seasonal, ADHW_monthly = ADHW(arr)
...
#        ADHW_yearly, ADHW_seasonal, ADHW_monthly = ADHW_C(arr)
    ...
    save_files_var(HWF_YEARLY=HWF_yearly, 
               ...
               HWF_MONTHLY=HWF_montly)
    save_files_var(HWA_YEARLY=HWA_yearly, 
               HWA_SEASONAL=HWA_seasonal, 
               HWA_MONTHLY=HWA_montly)
    save_files_var(HWM_YEARLY=HWM_yearly, 
               HWM_SEASONAL=HWM_seasonal, 
               HWM_MONTHLY=HWM_montly)
#    save_files_var(ADHW_YEARLY=ADHW_yearly, 
#               ADHW_SEASONAL=ADHW_seasonal, 
#               ADHW_MONTHLY=ADHW_montly)
